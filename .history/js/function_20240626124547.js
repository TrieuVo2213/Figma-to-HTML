...
// function không tên ko bị hoisting,tức là ta có thể gọi hàm đó trước khi nó được cài đặt
console.log(test()); //khi gọi hàm luôn luôn có dấu (),thiếu nó hàm sẽ ko được gọi
//Arrow function:là một hàm thuộc anonymous function,chẳng qua là thêm cách viết khác gọn hơn thôi.VÍ dụ
const test2 = () => {
  console.log("");
  // chỉ đơn giản là bỏ đi tên hàm và cả chữ function thay bằng dấu => thôi
  return null;
}; //Đây là cách viết khi có nhiều dòng code trong hàm test2,nếu trong hàm test2 chỉ có return
//thì có thể viết rút gọn trong một dòng như sau;
const temp2 = 12;
const checkNRF = () => temp2; //ko cần dùng return,narrow function sẽ return giá trị sau dấu =>

// còn có loại function nữa là IEFE
...
//nguyên nhân vì trong js thì khi gọi hàm cha thì chỉ có các câu lệnh trong hàm cha được thực thi,
//  hàm con sẽ ko được thực thi
//nó chỉ thực thi khi:
// 1: gọi hàm con ngay bên trong hàm cha
// 2:dùng hàm IFEF để thực thi hàm con ngay lập tức
// 3:return hàm con về,gọi hàm cha để lấy hàm con được return về rồi lưu lại trong một biến,
//  dùng biến đó gọi hàm con ra.

// nếu ko dùng 3 cách trên thì hàm con bên trong hàm cha sẽ không BAO GIỜ được thực thi
