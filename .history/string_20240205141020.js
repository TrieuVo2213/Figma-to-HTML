...
//{ .substr(index start,số kí tự muốn cắt) với index start là vị trí bắt đầu cắt
//  .substring(index start,index end) bắt đầu cắt từ index start đến index end}
//  .substring tương tự với .slice nhưng có một điểm yếu là nó không thể cắt từ cuối xâu như slice
/* điểm ưu của nó so với .slice là khi truyền tham số 1 lớn hơn tham số thứ 2 nó tự đảo vị trí lại
    trong khi .slice chỉ trả về chuỗi rỗng            */

//-------------------------------------------------------------
//Kết hợp nhiều phương thức String
const myStr2 = "    I am Developer   ";
//viết kết hợp các phương thức để loại bỏ khoảng trắng ở 2 đầu,đưa tất cả về IN HOA,thay thế chữ Developer,repeat 2 lần
console.log(myStr2.trim().replace(.replace("Developer","desighner")).toUpperCase().repeat(2));
