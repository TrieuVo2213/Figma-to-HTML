...
// nó sẽ check xem có 2 value có cùng giá trị không
//nếu giống nhau return false,còn nếu khác  nhau thì
//sau đó nó mới check kiểu dữ liệu của cả hai
// khác kiểu dữ liệu nó báo false,cùng kiểu dữ liệu nó báo true
console.log(`so sánh !== giữa 3 và 4 : ${3 !== "4"} `);
console.log(`so sánh !== giữa 3 và 4 : ${3 !== 4} `); // vừa ko bằng vừa cùng kiểu dữ liệu - > true
