...
console.log(Number(undefined)); // console trả vể NaN(not a number) do xâu không thể thành kiểu number
console.log(Number(null)); // console trả vể NaN(not a number) do xâu không thể thành kiểu number
