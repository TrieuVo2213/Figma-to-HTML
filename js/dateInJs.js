...
// setInterval sẽ thực hiện một công việc gì đó cứ sau mỗi  n(s)
// ví dụ
setTimeout(function () {
  console.log("call me");
}, 3000);
// dùng clearTimeout để dừng Timeout

setInterval(function () {
  console.log("call me");
}, 5000);
//Lưu ý:số truyền vào là mili giây nhưng setInterval thực hiện sau mỗi một giây
//và một giây = 1000 mili giây
// dùng clearInterval để reset thời gian chạy
