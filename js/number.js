...
// Math.sign(value); nó sẽ trả về 1 và -1,1 khi value dương,value âm thì trả về -1
...
//khác với isNaN, Number.isNaN chỉ trả về true khi Number.isNaN(NaN),hoặc là(Number.NaN) hoặc là (0/0)
