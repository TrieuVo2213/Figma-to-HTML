// coercion là ép kiểu ,js sẽ cố cưỡng chế ép kiểu trước khi thực hiện phép so sánh
//hay tính toán giữa các kiểu giữ liệu khác nhau
...
console.log(10 - "10"); // -> 0
console.log(null + ""); // -> null,phép cộng nên ưu tiên phép cộng sâu
...
console.log(`So sánh !==  : ${3 !== "3"}`); // true
console.log(`so sánh !== giữa null và 0 : ${null !== 0} `);
console.log(`so sánh !== giữa 3 và 4 : ${4 !== "4"} `); // true
console.log(`so sánh !== giữa 3 và 4 : ${3 !== 4} `); // true
// logic so sánh !===
// 2 values sẽ compare về mặt giá trị
//nếu khác nhau về mặt giá trị - > return true.Ngược lại compare data types
//nếu data types giống nhau  thì return false,ngược lại return true
