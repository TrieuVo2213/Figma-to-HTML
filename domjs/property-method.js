...
// li.getAttribute("class"); như này sẽ báo lỗi do li là một danh sách,có thể có các class khác nhau với mỗi thẻ li
li.forEach((item) => {
...
p.removeAttribute("styles"); // --> nó sẽ xóa thuộc tính style của node đó
